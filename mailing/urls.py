...
from mailing.services import run_mailing, block_mailing
from mailing.views import MailingListView, MailingDetailView, MailingCreateView, MailingUpdateView, MailingDeleteView, \
    ...
    MessageListView, IndexView, MailingAttemptListView
...
urlpatterns = [
    ...
    path('recipientmailing/', cache_page(1)(RecipientMailingListView.as_view()), name='recipientmailing_list'),
    path('recipientmailing/<int:pk>/detail/', cache_page(60)(RecipientMailingDetailView.as_view()), name='recipientmailing_detail'),
